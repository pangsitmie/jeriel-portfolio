...
const Nav = () => {
  ...
  return (
    <nav>
      ...
      <motion.a whileHover={{ scale: 1.1 }} href="#experience" onClick={() => setActiveNav("#experience")} className={activeNav === "#experience" ? "active" : ""}><BiBook /></motion.a>
      <motion.a whileHover={{ scale: 1.1 }} href="#service" onClick={() => setActiveNav("#service")} className={activeNav === "#service" ? "active" : ""}><RiServiceLine /></motion.a>
